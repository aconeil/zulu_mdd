...
zulumdd_train = zulumdd_train.remove_columns(["gender", "grader", "age", "scores", "scores_tones", "scores_inserts", "speaker", "l1","other_languages","semesters_study","pre_uni_years", "residency","birthplace"])
...
zulumdd_train = zulumdd_train.map(prepare_dataset, remove_columns=zulumdd_train.column_names)
...
training_args = TrainingArguments(
  output_dir='/N/slate/aconeil/w2v-bert-2.0-zuluMDD',
