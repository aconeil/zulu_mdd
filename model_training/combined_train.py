...
com_train = com_train.map(remove_special_characters)

vocab_train = com_train.map(extract_all_chars, batched=True, batch_size=-1, keep_in_memory=True, remove_columns=com_train.column_names)
...
com_train = com_train.map(prepare_dataset, remove_columns=com_train.column_names)
